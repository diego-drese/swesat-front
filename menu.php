<div
    ...
    <ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
        <li class="m-menu__item " aria-haspopup="true" >
            <a  href="inicio.php" class="m-menu__link ">
                ...
                <ul class="m-menu__subnav">
                    ...
                    <li class="m-menu__item" aria-haspopup="true" id="contato">
                        <a  href="#" class="m-menu__link ">
                            ...
                            <span class="m-menu__link-text" >Contatos</span>
                        </a>
                    </li>
                    <li class="m-menu__item" aria-haspopup="true" id="mensagem">
                        <a  href="#" class="m-menu__link ">
                            <i class="m-menu__link-bullet m-menu__link-bullet--dot">
                                <span></span>
                            </i>
                    ...
                    <li class="m-menu__item" aria-haspopup="true" id="grupo">
                        <a  href="#" class="m-menu__link ">
                            <i class="m-menu__link-bullet m-menu__link-bullet--dot">
                                <span></span>
                            </i>
                            <span class="m-menu__link-text">Grupos</span>
                        </a>
                    </li>
                    <li class="m-menu__item" aria-haspopup="true" id="telefone">
                        <a  href="#" class="m-menu__link ">
                            <i class="m-menu__link-bullet m-menu__link-bullet--dot">
                                <span></span>
                            </i>
                            <span class="m-menu__link-text">Telefones</span>
                        </a>
                    </li>
                </ul>
            </div>
